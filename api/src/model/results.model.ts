...
export default class Results {
    ...
    static async retrieve(): Promise<Results | null> {
        return new Promise((resolve, reject) => {
            sql.query(`SELECT * FROM lms_patient_results ORDER BY name ASC`, (err, res: any) => {
                if (err) {
                    reject(
    ...
    static async delete(test_id: number | string, patient_id: number | string): Promise<any | null> {
        return new Promise((resolve, reject) => {
            sql.query(
